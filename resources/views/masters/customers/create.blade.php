                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <select id="customer_type"
                                        ...
                                        <option value="Perumahan"
                                            {{ old('customer_type') === 'Perumahan' ? 'selected' : '' }}>
                                            Perumahan
                                        </option>
                                        <option value="Komersil"
                                            {{ old('customer_type') === 'Komersil' ? 'selected' : '' }}>
                                            Komersil
                                        </option>
                                        <option value="Industri"
                                            {{ old('customer_type') === 'Industri' ? 'selected' : '' }}>
                                            Industri
                                        </option>
                                    </select>
                                    @error('customer_type')
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('name') is-invalid @enderror"
                                        placeholder="Nama Pelanggan" name="name" value="{{ old('name') }}">
                                    @error('name')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('block') is-invalid @enderror"
                                        placeholder="Blok" name="block" value="{{ old('block') }}">
                                    @error('block')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('remarks') is-invalid @enderror"
                                        placeholder="Catatan" name="remarks" value="{{ old('remarks') }}">
                                    @error('remarks')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
