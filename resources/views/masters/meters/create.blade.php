                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control @error('brand') is-invalid @enderror"
                                        placeholder="Merek" name="brand" value="{{ old('brand') }}">
                                    @error('brand')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <select id="meter_type" class="form-control @error('meter_type') is-invalid @enderror"
                                        name="meter_type">
                                        <option value="Digital" {{ old('meter_type') === 'Digital' ? 'selected' : '' }}>
                                            Digital
                                        </option>
                                        <option value="Analog" {{ old('meter_type') === 'Analog' ? 'selected' : '' }}>
                                            Analog
                                        </option>
                                    </select>
                                    @error('meter_type')
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control @error('meter_number') is-invalid @enderror"
                                        placeholder="Meter Number" name="meter_number" value="{{ old('meter_number') }}">
                                    @error('meter_number')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input type="text" class="form-control @error('remarks') is-invalid @enderror"
                                        placeholder="Remarks" name="remarks" value="{{ old('remarks') }}">
                                    @error('remarks')
                                        <div class="invalid-feedback">
                                            {{ $message }}
                                        </div>
