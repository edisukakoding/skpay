                            ...
                            <div class="form-row">
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="text" class="form-control @error('type') is-invalid @enderror"
                                        placeholder="Cth: Rumah Tangga A" name="type"
                                        value="{{ old('type', $rate->type) }}">
                                    @error('type')
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <input type="number" class="form-control @error('fixed_fee') is-invalid @enderror"
                                        placeholder="Abodement" name="fixed_fee"
                                        ...
                                        @foreach ($rate->rateDetails as $i => $item)
                                            ...
                                            <tr data-id="{{ $rowNum }}">
                                                ...
                                                <td><input type="text" class="form-control form-control-sm"
                                                        name="details[{{ $rowNum }}][description]"
                                                        value="{{ $item->description }}"></td>
                                                <td><input type="number" class="form-control form-control-sm text-right"
                                                        name="details[{{ $rowNum }}][threshold_limit]"
                                                        value="{{ $item->threshold_limit }}"></td>
                                                <td><input type="number" class="form-control form-control-sm text-right"
                                                        name="details[{{ $rowNum }}][price]"
                                                        value="{{ $item->price }}"></td>
